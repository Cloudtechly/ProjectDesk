...
يتكوّن هذا المستند من خط الأساس الكامل المعتمد سابقًا، ثم ملحق تطوير إلزامي يحدّثه. عند التعارض، تكون متطلبات ملحق نسخة التطوير هي السائدة داخل فرع `develop` فقط.
