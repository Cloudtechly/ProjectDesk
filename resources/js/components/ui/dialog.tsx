...
const DialogFocusReturnContext = React.createContext<
...
function Dialog({
  ...
  return (
    <DialogFocusReturnContext.Provider value={focusReturnRef}>
...
function DialogTrigger({
  ...
  const focusReturnRef = React.useContext(DialogFocusReturnContext)
  const rememberTrigger = React.useCallback(
    (element: EventTarget | null) => {
      if (element instanceof HTMLElement && focusReturnRef) {
...
function DialogContent({
  ...
  const handleCloseAutoFocus = React.useCallback(
    (event: Event) => {
      ...
      if (event.defaultPrevented || !focusReturnRef?.current?.isConnected) {
        return
      }
    ...
    [focusReturnRef, onCloseAutoFocus]
  )
